...
cd ../../../../../../..
rm -f dist/bikeReporter.aab

cp platforms/android/app/build/outputs/bundle/release/app-release.aab dist/bikeReporter.aab

GREEN=$(tput setaf 2)
printf "\n\n${GREEN}File created at: dist/bikeReporter.aab\n\n"
